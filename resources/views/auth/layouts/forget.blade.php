        ...
        <div class="forny-inner">
            <div class="forny-form">
                <div class="mb-8 text-center forny-logo">
                    <img style="max-height:80px" src="{{ asset('resources/assets/img/timesLogo.png') }}">
                </div>
                <div class="text-center">
                    <h4>{{ get_title() }}</h4>
                    <p class="mb-10">Recover Your Password</p>

                    @if ($errors->any())
                        <p class="alert alert-danger" id="alert">{{ $errors->first() }}</p>
                    ...
                    @if(Session::has('success_msg'))
                        <p class="alert alert-success" id="alert">{{ Session::get('success_msg') }}</p>
                ...
                @if($otpSend)
                    ...
                    <form method="POST" action="{{ route('verify-forget') }}">
                        @csrf
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input required class="form-control" name="otp" type="text" autocomplete="off"  placeholder="4 Digit OTP">
                            </div>
                        </div>
                        ...
                        <div class="form-group password-field">
                            <div class="input-group">
                                ...
                                <input required class="form-control" name="new_password" type="password" placeholder="Enter New Password" autocomplete="new-password"> 
                ...
                @else
                    <form method="POST" action="{{ route('forgetAction') }}">
                        @csrf
                        <div class="form-group">
                            <div class="input-group">
                                <div class="input-group-prepend">
                                ...
                                <input required class="form-control" name="email" type="text"
                                    value="{{ old('email') }}" placeholder="Email/Username">
                            </div>
...
@section('title')
    <title>Admin Login - {{ get_title() }}</title>
@endsection
